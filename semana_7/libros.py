...
class Interfaz:
    def __init__(self, root, gestor_libros):
        ...
        self.anio_label = tk.Label(root, text="Año de Publicación:")
        self.anio_label.grid(row=2, column=0)
        self.anio_entry = tk.Entry(root)
        self.anio_entry.grid(row=2, column=1)
        ...
        self.exportar_button.grid(row=4, column=0, columnspan=2)
        

        self.lista_libros = tk.Listbox(root, width=50)
        self.lista_libros.grid(row=5, column=0, columnspan=2)
        self.cargar_libros()
